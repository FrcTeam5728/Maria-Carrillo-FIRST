...
public class DriveSubsystemSparkMax extends DriveSubsystem {
  ...
  public DriveSubsystemSparkMax() {
    ...
    leftLeader = new SparkMax(LEFT_LEADER_ID_SPARKMAX, MotorType.kBrushed);
    leftFollower = new SparkMax(LEFT_FOLLOWER_ID_SPARKMAX, MotorType.kBrushed);
    rightLeader = new SparkMax(RIGHT_LEADER_ID_SPARKMAX, MotorType.kBrushed);
    rightFollower = new SparkMax(RIGHT_FOLLOWER_ID_SPARKMAX, MotorType.kBrushed);
