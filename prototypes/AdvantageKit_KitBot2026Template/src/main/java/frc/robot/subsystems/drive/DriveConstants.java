...
public class DriveConstants {
  ...
  // Device CAN IDs
  public static final int pigeonCanId = 9; // Unused (we use NavX gyro instead)
  public static final int leftLeaderCanId = 33;
  public static final int leftFollowerCanId = 32;
