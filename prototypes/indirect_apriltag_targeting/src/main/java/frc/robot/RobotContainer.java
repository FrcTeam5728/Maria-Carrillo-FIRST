...
public class RobotContainer
{
  ...
  private final SwerveSubsystem       drivebase  = new SwerveSubsystem(new File(Filesystem.getDeployDirectory(),
                                                                                "swerve/neo"),
                                                                  limelight);
  private final TrackAprilTagCommand trackAprilTagCommand;
   ...
   */
  private final SwerveInputStream driveDirectAngle = driveAngularVelocity.copy().withControllerHeadingAxis(driverXbox::getRightX,
  ...
  private final SwerveInputStream driveAngularVelocityKeyboard = SwerveInputStream.of(drivebase.getSwerveDrive(),
                                                                        () -> -driverXbox.getLeftY(),
                                                                        () -> -driverXbox.getLeftX())
  ...
  {
    // Initialize commands
    trackAprilTagCommand = new TrackAprilTagCommand(limelight, drivebase);
  ...
  private void configureBindings()
  {
    ...
    // Keyboard driving commands (for simulation/testing)
...
//                              );
    ...
    {
      // A button binding moved to configureButtonBindings()
  ...
  private void configureButtonBindings() {
    // Track the nearest AprilTag when the 'A' button is pressed
    driverXbox.a().whileTrue(trackAprilTagCommand);
  }

  private void configureAutonChooser() {
    // Simple auton chooser without AutonLoader
    autonChooser.setDefaultOption("Default Auto", "default");
