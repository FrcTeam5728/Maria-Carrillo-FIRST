...
public final class Constants {
  public static final class FactoryConstants {
    ...
    public static final String DRIVE_SUBSYSTEM_TYPE = "VICTORSPX";

    // Fuel subsystem type selection: "SPARKMAX" or "VICTORSPX"
    public static final String FUEL_SUBSYSTEM_TYPE = "VICTORSPX";
  }

  public static final class DriveConstants {
    // Motor controller IDs for drivetrain motors
    public static final int LEFT_LEADER_ID_SPARKMAX = 1;
    public static final int LEFT_FOLLOWER_ID_SPARKMAX = 2;
    public static final int RIGHT_LEADER_ID_SPARKMAX = 3;
    public static final int RIGHT_FOLLOWER_ID_SPARKMAX = 4;
  ...
  public static final class FuelConstants {
    ...
    public static final int FEEDER_MOTOR_ID_SPARKMAX = 6;
    public static final int INTAKE_LAUNCHER_MOTOR_ID_SPARKMAX = 5;
