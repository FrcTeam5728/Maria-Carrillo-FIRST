...
public class RobotContainer
{
  ...
  // Commands
  private final TrackAprilTagCommand trackAprilTagCommand = new TrackAprilTagCommand(limelight, swerve);
...
//                              );
    ...
    {
      driverXbox.a().onTrue(trackAprilTagCommand);
      driverXbox.b().onTrue(Commands.runOnce(() -> {
        if (trackAprilTagCommand.isScheduled()) {
          trackAprilTagCommand.cancel();
        }
      }));
